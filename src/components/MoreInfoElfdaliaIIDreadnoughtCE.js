...
import Elfdalia_II_Dreadnought_CE_Hero from '../assets/images/Elfdalia_II_Dreadnought_CE_Hero.png';
import Elfdalia_II_Header from '../assets/images/Elfdalia_II_Header.jpg';
import Acoustic_Elfdalia_II_Dreadnought_CE from '../assets/images/Acoustic_Elfdalia_II_Dreadnought_CE.png';
import Acoustic_Elfdalia_II_Dreadnought_CE_Back from '../assets/images/Acoustic_Elfdalia_II_Dreadnought_CE_Back.png';
import Logo_Hagstrom_Lilie_Black from '../assets/images/Logo_Hagstrom_Lilie_Black.png';
import Colors_Natural_Ceder from '../assets/images/Colors_Natural_Ceder.png';
...
import Acoustics_2016_Detail_9 from '../assets/images/Acoustics_2016_Detail_9.jpg';
import Acoustics_2016_Detail_10 from '../assets/images/Acoustics_2016_Detail_10.jpg';
...
const IntroBackground = styled.div`
  ...
  background-image: url(${Elfdalia_II_Header});
  display: flex;
  flex-direction: row;
...
const MoreInfoElfdaliaIIDreadnoughtCE = () => {
      ...
      <Wrapper>
        <IntroBackground>
          <IntroContainer>
            <IntroTitle>
              Elfdalia
              <IntroParagraph>Dynamic & Harmonious</IntroParagraph>
            </IntroTitle>
            <IntroImage src={Elfdalia_II_Dreadnought_CE_Hero} alt='' />
          </IntroContainer>
        </IntroBackground>
        <NavContainer>
          <NavWrapper>
            <NavLinks>
              ...
              <span>/</span>
              <HashLink to='/AcousticGuitars#elfdaliaII'>Elfdalia II</HashLink>
              <span>/</span>
        ...
        <MainContentWrapper>
          <LeftContentWrapper>
            <MediaTitle>Hagstrom Elfdalia II Dreadnought CE</MediaTitle>
            <Paragraph>
              <LogoSpan>
                <Logo src={Logo_Hagstrom_Lilie_Black} alt='' />
              </LogoSpan>
              The Elfdalia series uses a Cedar top placed upon Mahogany back and
              sides, producing a lively tone with prominent upper-mid range
              frequencies. Typical of guitars with Cedar tops, Hagstrom’s
              Elfdalia is rich with overtones, and the tighter wood grain allows
              the guitar to be more responsive. Finger stylists and flatpickers
              both seek out this combination of tone woods.
            </Paragraph>
          </LeftContentWrapper>
          <RightContentWrapper>
            ...
            <Colors>
              <ColorsWrapper>
                <Image
                  src={Colors_Natural_Ceder}
                  alt=''
                  style={{ width: '70px', height: 'auto' }}
                />
                <ColorsText>Natural Ceder</ColorsText>
              </ColorsWrapper>
            </Colors>
          </RightContentWrapper>
        </MainContentWrapper>
        <MainContentWrapper>
          <Details>
            ...
            <DetailsWrapper>
              <Image src={Acoustics_2016_Detail_9} alt='' />
              <DetailsText>Solid Top</DetailsText>
            </DetailsWrapper>
            <DetailsWrapper>
              <Image src={Acoustics_2016_Detail_10} alt='' />
              <DetailsText>Resinator wood Bridge</DetailsText>
            </DetailsWrapper>
            <DetailsWrapper>
            ...
            <DetailsWrapper>
              <Image src={Acoustics_2016_Detail_11} alt='' />
              <DetailsText>Strap Button</DetailsText>
            </DetailsWrapper>
            <DetailsWrapper>
              <Image src={Acoustics_2016_Detail_13} alt='' />
        ...
        <LightboxWrapper>
          <Lightbox
            ...
            close={() => setOpen(false)}
            slides={[
              { src: Acoustic_Elfdalia_II_Dreadnought_CE },
              { src: Acoustic_Elfdalia_II_Dreadnought_CE_Back },
            ]}
          />
        </LightboxWrapper>
        <SpecsWrapper>
          <LeftSpecsWrapper>
            <MediaTitle>Elfdalia Dreadnought II CE Specs</MediaTitle>
            <MediaTitleSecondary>Body</MediaTitleSecondary>
            <ul>
              <li>Material: Mahogany</li>
              <li>Shape: Dreadnought</li>
            ...
            <ul>
              ...
              <li>
                Strings: D'Addario Phosphor Bronze EJ26 Custom Light (11-52)
              </li>
            </ul>
          ...
          <RightSpecsWrapper>
            <MediaTitle>Elfdalia Dreadnought II CE Standards</MediaTitle>
            <StandardsWrapper>
...
export default MoreInfoElfdaliaIIDreadnoughtCE;
