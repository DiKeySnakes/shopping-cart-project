...
import Elfdalia_Dreadnought_Hero from '../assets/images/Elfdalia_Dreadnought_Hero.png';
import Elfdalia_II_Header from '../assets/images/Elfdalia_II_Header.jpg';
import Acoustic_Elfdalia_II_Dreadnought from '../assets/images/Acoustic_Elfdalia_II_Dreadnought.png';
import Acoustic_Elfdalia_II_Dreadnought_Back from '../assets/images/Acoustic_Elfdalia_II_Dreadnought_Back.png';
...
const MoreInfoElfdaliaIIDreadnought = () => {
      ...
      <Wrapper>
        <IntroBackground>
          <IntroContainer>
            ...
            <IntroImage src={Elfdalia_Dreadnought_Hero} alt='' />
          </IntroContainer>
        </IntroBackground>
        <NavContainer>
          <NavWrapper>
        ...
        <MainContentWrapper>
          <LeftContentWrapper>
            <MediaTitle>Hagstrom Elfdalia II Dreadnought</MediaTitle>
            <Paragraph>
              <LogoSpan>
        ...
        <LightboxWrapper>
          <Lightbox
            ...
            close={() => setOpen(false)}
            slides={[
              { src: Acoustic_Elfdalia_II_Dreadnought },
              { src: Acoustic_Elfdalia_II_Dreadnought_Back },
            ]}
          />
        </LightboxWrapper>
        <SpecsWrapper>
          <LeftSpecsWrapper>
            <MediaTitle>Elfdalia Dreadnought II Specs</MediaTitle>
          ...
          <RightSpecsWrapper>
            <MediaTitle>Elfdalia Dreadnought II Standards</MediaTitle>
            <StandardsWrapper>
...
export default MoreInfoElfdaliaIIDreadnought;
