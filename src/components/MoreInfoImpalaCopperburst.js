...
import Impala_Copperburst_Hero from '../assets/images/Impala_Copperburst_Hero.png';
import Impala_Copperburst_Header from '../assets/images/Impala_Copperburst_Header.jpg';
import Logo_Hagstrom_Lilie_Black from '../assets/images/Logo_Hagstrom_Lilie_Black.png';
import Colors_Copperburst from '../assets/images/Colors_Copperburst.png';
import HSIMP89_Detail_Logo from '../assets/images/HSIMP89_Detail_Logo.jpg';
import HSIMP89_Detail_Headstock from '../assets/images/HSIMP89_Detail_Headstock.jpg';
import HagstromImpalaCopperburst from '../assets/images/HagstromImpalaCopperburst.png';
import HagstromImpalaCopperburstBack from '../assets/images/HagstromImpalaCopperburstBack.png';
import Detail_impala_set_neck from '../assets/images/Detail_impala_set_neck.jpg';
import Detail_vintage_tremar_retroscape_impala from '../assets/images/Detail_vintage_tremar_retroscape_impala.jpg';
...
const IntroBackground = styled.div`
  ...
  background-image: url(${Impala_Copperburst_Header});
  display: flex;
  flex-direction: row;
...
const MoreInfoImpalaCopperburst = () => {
      ...
      <Wrapper>
        <IntroBackground>
          <IntroContainer>
            ...
            <IntroImage src={Impala_Copperburst_Hero} alt='' />
          </IntroContainer>
        </IntroBackground>
        <NavContainer>
          <NavWrapper>
            <NavLinks>
              ...
              <span>/</span>
              <NavLink>Impala Copperburst</NavLink>
            </NavLinks>
            <ShareLinks>
              <NavLink>
        ...
        <MainContentWrapper>
          <LeftContentWrapper>
            <MediaTitle>Hagstrom Impala Copperburst</MediaTitle>
            <Paragraph>
              <LogoSpan>
                <Logo src={Logo_Hagstrom_Lilie_Black} alt='' />
              </LogoSpan>
              Taylor York was introduced to Hagstrom by his brother, Justin, who
              has been a Hagstrom Artist for many years. It was our{' '}
              <Link to='/MoreInfoRetroScapeImpala'>RetroScape Impala</Link> that
              first captured Taylor’s imagination. Shortly after learning about
              the Impala, Taylor began work in the studio recording Paramore’s
              new album, After Laughter, and before too long the Impala found
              its way into the mix of instruments used. As the recording process
              continued the Impala and several other Hagstrom models were
              selected for various tracks; however, it was the Impala that
            ...
            <Paragraph>
              ...
              to start their extensive touring schedule in support of After
              Laughter, we started working with Taylor on some modifications to
              our standard Impala specification to better suit his touring
              needs. After becoming interested in the brand, Taylor acquired a
              1960’s vintage <Link to='/MoreInfoViking'>Viking</Link> and fell
              in love with its famously thin neck. So, it’s natural that he
              asked us to build his Impala with our “Ultra-Thin” 17mm neck
              profile. Next in line was to choose a finish from a brighter
              palette, yet keeping with the Impala’s vintage vibe. After several
              experiments, Taylor suggested a wonderful copper-burst finish,
              which combines old-school class with a modern vibrancy. After
              making a few adjustments to the hardware for stage- and road-
              worthiness we finalized the design and the rest is history. We are
              so proud every time the Impala gets its regular stage time during
              Paramore’s busy touring schedule.
            </Paragraph>
            <MediaTitle>A true and authentic voice</MediaTitle>
            <Paragraph>
              Hagstrom’s Impala exactly reproduces the pickups included with the
              first production models in the early 1960’s. A single, massive
              AlNi-Co-5 magnet fills each of the pickups, a radical departure
              from the typical approach of placing one small cylindrical magnet
              under each string. The resulting sound is bright and percussive
              with a robust mid-range, a true and authentic voice for anyone
              looking to the early 1960’s for sonic inspiration. Taylor
              recognized this immediately as exactly the kind of sound he was
              looking for on After Laughter.
            </Paragraph>
            <Paragraph>
              Each Impala Copperburst we deliver to guitarists worldwide is
              identical in every way to the guitar Taylor uses on stage, and we
              are deeply honored that he has selected this Hagstrom model to
              help achieve his artistic goals.
            </Paragraph>
            <MediaTitle>
          ...
          <RightContentWrapper>
            ...
            <Colors>
              <ColorsWrapper>
                <Image
                  src={Colors_Copperburst}
                  alt=''
                  style={{ width: '70px', height: 'auto' }}
                />
                <ColorsText>Copperburst</ColorsText>
              </ColorsWrapper>
            </Colors>
          </RightContentWrapper>
        </MainContentWrapper>
        <MainContentWrapper>
          <Details>
            <DetailsWrapper>
              <Image src={HSIMP89_Detail_Logo} alt='' />
              <DetailsText>Bridge Pickup and Hagstrom Logo</DetailsText>
            </DetailsWrapper>
            <DetailsWrapper>
              <Image src={HSIMP89_Detail_Headstock} alt='' />
              <DetailsText>Impala Copperburst Headstock</DetailsText>
            </DetailsWrapper>
          </Details>
        </MainContentWrapper>
        <Quote>
        ...
        <LightboxWrapper>
          <Lightbox
            ...
            close={() => setOpen(false)}
            slides={[
              { src: HagstromImpalaCopperburst },
              { src: HagstromImpalaCopperburstBack },
            ]}
          />
        </LightboxWrapper>
        <SpecsWrapper>
          <LeftSpecsWrapper>
            <MediaTitle>Impala Copperburst Specs</MediaTitle>
            ...
            <ul>
              <li>Joint: Mortise and Long Tenon</li>
              <li>Material: Mahogany</li>
            ...
            <ul>
              <li>
                Pickups: 2 x Hagstrom Vintage Retro-S Single Coil AlNiCo-5
              </li>
              <li>Pickup Selector: 6 x Individual Pickup Selector</li>
              <li>Tone Shaping Switches</li>
              <li>Controls: 1 x Master Volume with R/C Circuit</li>
            </ul>
            <MediaTitleSecondary>Parts</MediaTitleSecondary>
            <ul>
              <li>Bridge: Long-Throw Tune-O-Matic Bridge</li>
              <li>Tremar: Hagstrom Vintage</li>
          ...
          <RightSpecsWrapper>
            <MediaTitle>Impala Copperburst Standards</MediaTitle>
            <StandardsWrapper>
            ...
            <StandardsWrapper>
              <StandardsImageWrapper>
                <Image
                  src={Detail_vintage_tremar_retroscape_impala}
                  alt=''
                  style={{
                    height: 'auto',
                    maxWidth: '100%',
              ...
              <StandardsTextWrapper>
                ...
                <p>
                  ...
                  roller bridge and the Graphtech Black TUSQ XL nut,{<br />} the
        ...
        <VideoWrapper>
          <MediaTitle>
            <a
              href='https://youtu.be/AEB6ibtdPZc'
              target='_blank'
              rel='noopener noreferrer'>
              Paramore - Hard Times
            </a>
          ...
          <Video>
            <ReactPlayer
              url='https://youtu.be/AEB6ibtdPZc'
              width='100%'
              height='100%'
            />
          </Video>
...
export default MoreInfoImpalaCopperburst;
