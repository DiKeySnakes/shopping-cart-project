...
import Orsa_Grand_Auditorium_CE_Hero from '../assets/images/Orsa_Grand_Auditorium_CE_Hero.png';
import Orsa_Header from '../assets/images/Orsa_Header.jpg';
import Acoustic_Orsa_Grand_Auditorium_CE from '../assets/images/Acoustic_Orsa_Grand_Auditorium_CE.png';
import Acoustic_Orsa_Grand_Auditorium_CE_Back from '../assets/images/Acoustic_Orsa_Grand_Auditorium_CE_Back.png';
...
const MoreInfoOrsaGrandAuditoriumCE = () => {
      ...
      <Wrapper>
        <IntroBackground>
          <IntroContainer>
            ...
            <IntroImage src={Orsa_Grand_Auditorium_CE_Hero} alt='' />
          </IntroContainer>
        </IntroBackground>
        <NavContainer>
          <NavWrapper>
        ...
        <MainContentWrapper>
          <LeftContentWrapper>
            <MediaTitle>Hagstrom Orsa Grand Auditorium CE</MediaTitle>
            <Paragraph>
              <LogoSpan>
            ...
            <Paragraph>
              Ovangkol is a material with the appearance and density of Ovangol
              is a material with the appearance and density of rosewood.
              ...
              spruce top Ovangol produces the warm, full spectrum sound
            ...
            <Paragraph>
              ...
              colors of the Ovangol back and sides. A Maple heel cap completes
        ...
        <LightboxWrapper>
          <Lightbox
            ...
            close={() => setOpen(false)}
            slides={[
              { src: Acoustic_Orsa_Grand_Auditorium_CE },
              { src: Acoustic_Orsa_Grand_Auditorium_CE_Back },
            ]}
          />
        </LightboxWrapper>
        <SpecsWrapper>
          <LeftSpecsWrapper>
            <MediaTitle>Orsa Grand Auditorium CE Specs</MediaTitle>
            <MediaTitleSecondary>Body</MediaTitleSecondary>
            <ul>
              <li>Material: Ovangol</li>
              <li>Shape: Grand Auditorium CE</li>
          ...
          <RightSpecsWrapper>
            <MediaTitle>Orsa Grand Auditorium CE Standards</MediaTitle>
            <StandardsWrapper>
...
export default MoreInfoOrsaGrandAuditoriumCE;
