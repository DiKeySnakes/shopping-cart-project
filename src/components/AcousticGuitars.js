    ...
    <Wrapper key={nanoid()}>
      ...
      <MainContentWrapper key={nanoid()}>
        ...
        <Row key={nanoid()} id='elfdaliaII'>
          ...
          <ItemBox key={nanoid()}>
            <Link
              to='/MoreInfoElfdaliaIIDreadnought'
              style={{ textDecoration: 'none' }}
              key={nanoid()}>
              <ImageWrapper key={nanoid()}>
                <Image
            ...
            <Link
              to='/MoreInfoElfdaliaIIDreadnoughtCE'
              style={{ textDecoration: 'none' }}
              key={nanoid()}>
              <ImageWrapper key={nanoid()}>
                <Image
            ...
            <Link
              to='/MoreInfoElfdaliaIIGrandAuditorium'
              style={{ textDecoration: 'none' }}
              key={nanoid()}>
              <ImageWrapper key={nanoid()}>
                <Image
            ...
            <Link
              to='/MoreInfoElfdaliaIIGrandAuditoriumCE'
              style={{ textDecoration: 'none' }}
              key={nanoid()}>
              <ImageWrapper key={nanoid()}>
                <Image
        ...
        <Row key={nanoid()} id='siljanII'>
          ...
          <ItemBox key={nanoid()}>
            <Link
              to='/MoreInfoSiljanIIDreadnought'
              style={{ textDecoration: 'none' }}
              key={nanoid()}>
              <ImageWrapper key={nanoid()}>
                <Image
            ...
            <Link
              to='/MoreInfoSiljanIIGrandAuditorium'
              style={{ textDecoration: 'none' }}
              key={nanoid()}>
              <ImageWrapper key={nanoid()}>
                <Image
            ...
            <Link
              to='/MoreInfoSiljanIIGrandAuditoriumCE'
              style={{ textDecoration: 'none' }}
              key={nanoid()}>
              <ImageWrapper key={nanoid()}>
                <Image
