...
import HJ500_Hero from '../assets/images/HJ500_Hero.png';
...
import HSHJ50001_Detail_0001 from '../assets/images/HSHJ50001_Detail_0001.jpg';
import HSHJ50009_Detail_0001 from '../assets/images/HSHJ50009_Detail_0001.jpg';
import HSHJ50009_1140Px from '../assets/images/HSHJ50009_1140Px.png';
import HSHJ50001_1140Px from '../assets/images/HSHJ50001_1140Px.png';
      ...
      <Wrapper>
        <IntroBackground>
          <IntroContainer>
            <IntroTitle>
              HJ500
              <IntroParagraph>Classic Masterpiece</IntroParagraph>
            </IntroTitle>
            <IntroImage src={HJ500_Hero} alt='' />
          </IntroContainer>
        </IntroBackground>
        <NavContainer>
          <NavWrapper>
        ...
        <MainContentWrapper>
          <LeftContentWrapper>
            <MediaTitle>Hagstrom HJ500</MediaTitle>
            <Paragraph>
              <LogoSpan>
                <Logo src={Logo_Hagstrom_Lilie_Black} alt='' />
              </LogoSpan>
              In 1969 the legendary luthier James “Jimmy” D’Aquisto began a
              cooperation with Hagstrom that was to last nearly 10 years.
              Hagstrom’s hollow-body archtop jazz guitar series is the result,
              and the master’s craft is unmistakably written all over these fine
              instruments. In fact, the asymmetrical headstock used for these
              guitars and now used for most current Hagstrom models, was Jimmy’s
              design. Immaculately clean, well rounded jazz tones for single
              note patterns and walking-bass chordal comping are the HJ500’s
              home turf, although it is fully capable of taking a different
              route into rock-oriented soundscapes when necessary.
            </Paragraph>
          </LeftContentWrapper>
          <RightContentWrapper>
        ...
        <MainContentWrapper>
          <Details>
            <DetailsWrapper>
              <Image src={HSHJ50001_Detail_0001} alt='' />
              <DetailsText></DetailsText>
            </DetailsWrapper>
            <DetailsWrapper>
              <Image src={HSHJ50009_Detail_0001} alt='' />
              <DetailsText></DetailsText>
            </DetailsWrapper>
          </Details>
        </MainContentWrapper>
        ...
        <LightboxWrapper>
          <Lightbox
            ...
            open={open}
            close={() => setOpen(false)}
            slides={[{ src: HSHJ50009_1140Px }, { src: HSHJ50001_1140Px }]}
          />
        </LightboxWrapper>
        <SpecsWrapper>
          <LeftSpecsWrapper>
            <MediaTitle>HJ500 Specs</MediaTitle>
          ...
          <RightSpecsWrapper>
            <MediaTitle>HJ500 Standards</MediaTitle>
            <StandardsWrapper>
