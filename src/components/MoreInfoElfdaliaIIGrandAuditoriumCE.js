...
import Elfdalia_II_Grand_Auditorium_CE_Hero from '../assets/images/Elfdalia_II_Grand_Auditorium_CE_Hero.png';
import Elfdalia_II_Header from '../assets/images/Elfdalia_II_Header.jpg';
import Acoustic_Elfdalia_II_Grand_Auditorium_CE from '../assets/images/Acoustic_Elfdalia_II_Grand_Auditorium_CE.png';
import Acoustic_Elfdalia_II_Grand_Auditorium_CE_Back from '../assets/images/Acoustic_Elfdalia_II_Grand_Auditorium_CE_Back.png';
...
const MoreInfoElfdaliaIIGrandAuditoriumCE = () => {
      ...
      <Wrapper>
        <IntroBackground>
          <IntroContainer>
            ...
            <IntroImage src={Elfdalia_II_Grand_Auditorium_CE_Hero} alt='' />
          </IntroContainer>
        </IntroBackground>
        <NavContainer>
          <NavWrapper>
        ...
        <MainContentWrapper>
          <LeftContentWrapper>
            <MediaTitle>Hagstrom Elfdalia II Grand Auditorium CE</MediaTitle>
            <Paragraph>
              <LogoSpan>
        ...
        <LightboxWrapper>
          <Lightbox
            ...
            close={() => setOpen(false)}
            slides={[
              { src: Acoustic_Elfdalia_II_Grand_Auditorium_CE },
              { src: Acoustic_Elfdalia_II_Grand_Auditorium_CE_Back },
            ]}
          />
        </LightboxWrapper>
        <SpecsWrapper>
          <LeftSpecsWrapper>
            <MediaTitle>Elfdalia II Grand Auditorium CE Specs</MediaTitle>
          ...
          <RightSpecsWrapper>
            <MediaTitle>Elfdalia II Grand Auditorium CE Standards</MediaTitle>
            <StandardsWrapper>
...
export default MoreInfoElfdaliaIIGrandAuditoriumCE;
