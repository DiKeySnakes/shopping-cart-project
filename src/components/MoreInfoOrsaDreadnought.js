...
import Orsa_Dreadnought_Hero from '../assets/images/Orsa_Dreadnought_Hero.png';
import Orsa_Header from '../assets/images/Orsa_Header.jpg';
import Acoustic_Orsa_Dreadnought from '../assets/images/Acoustic_Orsa_Dreadnought.png';
import Acoustic_Orsa_Dreadnought_Back from '../assets/images/Acoustic_Orsa_Dreadnought_Back.png';
      ...
      <Wrapper>
        <IntroBackground>
          <IntroContainer>
            ...
            <IntroImage src={Orsa_Dreadnought_Hero} alt='' />
          </IntroContainer>
        </IntroBackground>
        <NavContainer>
          <NavWrapper>
        ...
        <MainContentWrapper>
          <LeftContentWrapper>
            <MediaTitle>Hagstrom Orsa Dreadnought</MediaTitle>
            <Paragraph>
              <LogoSpan>
        ...
        <LightboxWrapper>
          <Lightbox
            ...
            close={() => setOpen(false)}
            slides={[
              { src: Acoustic_Orsa_Dreadnought },
              { src: Acoustic_Orsa_Dreadnought_Back },
            ]}
          />
        </LightboxWrapper>
        <SpecsWrapper>
          <LeftSpecsWrapper>
            <MediaTitle>Orsa Dreadnought Specs</MediaTitle>
            <MediaTitleSecondary>Body</MediaTitleSecondary>
            <ul>
              <li>Material: Ovangkol</li>
          ...
          <RightSpecsWrapper>
            <MediaTitle>Orsa Dreadnought Standards</MediaTitle>
            <StandardsWrapper>
...
export default MoreInfoOrsaDreadnought;
