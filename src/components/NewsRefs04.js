      ...
      <NavContainer>
        <NavWrapper>
          <NavLinks>
            ...
            <span>/</span>
            <NavLink>Justin York Presents Hagstrom Guitar's Impala</NavLink>
          </NavLinks>
          <ShareLinks>
            <NavLink>
        ...
        <LeftContentWrapper>
          <News key={nanoid()}>
            <NewsWrapper key={nanoid()}>
              <Image src={HS_Justin_York_Impala} alt='' key={nanoid()} />
              ...
              <Paragraph>
                ...
                Justin York, touring guitarist with Grammy award-winning
                Paramore, give us his impressions of{' '}
                <Link to='/MoreInfoRetroScapeImpala'>
                  Hagstrom Guitar’s Impala
                </Link>
                , introduced in 1963 and now re-released as part of the new
                RetroScape Series. Justin then uses the Impala to get some
                serious retro-vibe tones in the studio.
              </Paragraph>
              <Paragraph>
                The Impala has two Pickups and the Condor features three
                Pickups.
              </Paragraph>
            </NewsWrapper>
          </News>
