...
import Orsa_Dreadnought_CE_Hero from '../assets/images/Orsa_Dreadnought_CE_Hero.png';
import Orsa_Header from '../assets/images/Orsa_Header.jpg';
import Acoustic_Orsa_Dreadnought_CE from '../assets/images/Acoustic_Orsa_Dreadnought_CE.png';
import Acoustic_Orsa_Dreadnought_CE_Back from '../assets/images/Acoustic_Orsa_Dreadnought_CE_Back.png';
import Logo_Hagstrom_Lilie_Black from '../assets/images/Logo_Hagstrom_Lilie_Black.png';
import Colors_Acoustic_Guitars_Natural from '../assets/images/Colors_Acoustic_Guitars_Natural.png';
import Logo_Hagstrom_Lilie from '../assets/images/Logo_Hagstrom_Lilie.png';
import Acoustics_2016_Detail_3 from '../assets/images/Acoustics_2016_Detail_3.jpg';
...
import Acoustics_2016_Detail_7 from '../assets/images/Acoustics_2016_Detail_7.jpg';
...
const IntroBackground = styled.div`
  ...
  background-image: url(${Orsa_Header});
  display: flex;
  flex-direction: row;
...
const MoreInfoOrsaDreadnoughtCE = () => {
      ...
      <Wrapper>
        <IntroBackground>
          <IntroContainer>
            <IntroTitle>
              Orsa
              <IntroParagraph>Wholesome and Distinguished Tone</IntroParagraph>
            </IntroTitle>
            <IntroImage src={Orsa_Dreadnought_CE_Hero} alt='' />
          </IntroContainer>
        </IntroBackground>
        <NavContainer>
          <NavWrapper>
        ...
        <MainContentWrapper>
          <LeftContentWrapper>
            <MediaTitle>Hagstrom Orsa Dreadnought CE</MediaTitle>
            <Paragraph>
              <LogoSpan>
                <Logo src={Logo_Hagstrom_Lilie_Black} alt='' />
              </LogoSpan>
              Hagstrom’s Orsa series is named after a town in the beautiful
              forested lake district near the original Hagstrom factory in
              Sweden.
            </Paragraph>
            <Paragraph>
              Ovangkol is a material with the appearance and density of
              rosewood. Hagstrom has selected this material because it is safely
              harvested from managed forests and fully compliant under all of
              the CITES endangered hardwood regulations. When married to a solid
              Sitka spruce top Ovangkol produces the warm, full spectrum sound
              associated with rosewood. Our dreadnought body shape enhances the
              guitar’s bass response.
            </Paragraph>
            <Paragraph>
              The Orsa’s body, fingerboard, and headstock are exquisitely bound
              with hard Maple, creating a refined accompaniment to the rich
              colors of the Ovangkol back and sides. A Maple heel cap completes
              the elegant incorporation of organic materials into the ornamental
            ...
            <Paragraph>
              ...
              contribute a level of tonal articulation usually found only in
              much more expensive instruments. Fishman’s ISYS pickup and preamp
              round out the package with authentic and expressive amplification
              support.
            </Paragraph>
          </LeftContentWrapper>
          <RightContentWrapper>
            ...
            <Colors>
              <ColorsWrapper>
                <Image
                  src={Colors_Acoustic_Guitars_Natural}
                  alt=''
        ...
        <MainContentWrapper>
          <Details>
            <DetailsWrapper>
              <Image src={Acoustics_2016_Detail_6} alt='' />
              <DetailsText>Iconic Hagstrom Headstock</DetailsText>
            </DetailsWrapper>
            <DetailsWrapper>
              <Image src={Acoustics_2016_Detail_3} alt='' />
              <DetailsText>Fingerboard with Pearloid Inlays</DetailsText>
            </DetailsWrapper>
            <DetailsWrapper>
            ...
            <DetailsWrapper>
              <Image src={Acoustics_2016_Detail_7} alt='' />
              <DetailsText>Soundhole with Rings</DetailsText>
            </DetailsWrapper>
            <DetailsWrapper>
        ...
        <LightboxWrapper>
          <Lightbox
            ...
            close={() => setOpen(false)}
            slides={[
              { src: Acoustic_Orsa_Dreadnought_CE },
              { src: Acoustic_Orsa_Dreadnought_CE_Back },
            ]}
          />
        </LightboxWrapper>
        <SpecsWrapper>
          <LeftSpecsWrapper>
            <MediaTitle>Orsa Dreadnought CE Specs</MediaTitle>
            <MediaTitleSecondary>Body</MediaTitleSecondary>
            <ul>
              <li>Material: Ovangol</li>
              <li>Shape: Dreadnought CE</li>
              <li>Top: Solid Sitka Spruce</li>
              <li>Maple Binding with Maple Heel Cap</li>
            </ul>
            <MediaTitleSecondary>Neck</MediaTitleSecondary>
            <ul>
              <li>Set Neck: Dovetail</li>
              <li>Material: Mahogany</li>
              <li>Two-Way Trussrod</li>
            ...
            <ul>
              ...
              <li>Maple Binding</li>
              <li>Scale Length: 24.75 Inch (628mm)</li>
              <li>Radius: 15"</li>
              <li>Inlays: Pearloid Inlays</li>
              <li>Frets: 20 Medium Jumbo</li>
            </ul>
            <MediaTitleSecondary>Electronics</MediaTitleSecondary>
            <ul>
              <li>Fishman Pickup</li>
              <li>Fishman ISYS Plus 301 Preamp System</li>
            </ul>
            <MediaTitleSecondary>Parts</MediaTitleSecondary>
            <ul>
              <li>Bridge: Resinator™</li>
              <li>Graph-Tech Tusq Saddle</li>
              <li>Tuning Keys: Hagstrom 18:1</li>
              <li>Strings: D'Addario EXP (12-53)</li>
            </ul>
            <MediaTitleSecondary>Case</MediaTitleSecondary>
            <ul>
              <li>Hagstrom Case C-57, optional</li>
              <li>Gigbag E-30, optional</li>
            </ul>
          </LeftSpecsWrapper>
          <RightSpecsWrapper>
            <MediaTitle>Orsa Dreadnought CE Standards</MediaTitle>
            <StandardsWrapper>
...
export default MoreInfoOrsaDreadnoughtCE;
