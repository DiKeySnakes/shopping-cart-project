...
import Mora_II_Concert_CE_Hero from '../assets/images/Mora_II_Concert_CE_Hero.png';
import Mora_II_Header from '../assets/images/Mora_II_Header.jpg';
import Acoustic_Mora_II_Concert_CE from '../assets/images/Acoustic_Mora_II_Concert_CE.png';
import Acoustic_Mora_II_Concert_CE_Back from '../assets/images/Acoustic_Mora_II_Concert_CE_Back.png';
...
const IntroBackground = styled.div`
  ...
  background-image: url(${Mora_II_Header});
  display: flex;
  flex-direction: row;
      ...
      <Wrapper>
        <IntroBackground>
          <IntroContainer>
            <IntroTitle>
              Mora
              <IntroParagraph>Radiant & Luminous</IntroParagraph>
            </IntroTitle>
            <IntroImage src={Mora_II_Concert_CE_Hero} alt='' />
          </IntroContainer>
        </IntroBackground>
        <NavContainer>
          <NavWrapper>
        ...
        <MainContentWrapper>
          <LeftContentWrapper>
            <MediaTitle>Hagstrom Mora II Concert CE</MediaTitle>
            <Paragraph>
              <LogoSpan>
                <Logo src={Logo_Hagstrom_Lilie_Black} alt='' />
              </LogoSpan>
              Hagstrom’s Mora series guitars use same tonewood species
              throughout the instrument. A solid Mahogany top is joined to
              mahogany back and sides for a beautifully warm looking instrument.
              An all-Mahogany guitar typically will sound more focused because
              the fundamental frequencies of each note are emphasized. Such a
              sound signature is often sought by finger-style soloists or
              guitarists whose specialty is single note picking.
            </Paragraph>
          </LeftContentWrapper>
          <RightContentWrapper>
        ...
        <LightboxWrapper>
          <Lightbox
            ...
            close={() => setOpen(false)}
            slides={[
              { src: Acoustic_Mora_II_Concert_CE },
              { src: Acoustic_Mora_II_Concert_CE_Back },
            ]}
          />
        </LightboxWrapper>
        <SpecsWrapper>
          <LeftSpecsWrapper>
            <MediaTitle>Mora II Concert CE Specs</MediaTitle>
            <MediaTitleSecondary>Body</MediaTitleSecondary>
            <ul>
              <li>Material: Mahogany</li>
              <li>Shape: Concert with Cutaway</li>
            ...
            <MediaTitleSecondary>Gigbag</MediaTitleSecondary>
            <ul>
              <li>Gigbag E-30, optional</li>
            </ul>
          </LeftSpecsWrapper>
          <RightSpecsWrapper>
            <MediaTitle>Mora II Concert CE Standards</MediaTitle>
            <StandardsWrapper>
...
export default MoreInfoMoraIIConcertCE;
