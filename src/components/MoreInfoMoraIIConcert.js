...
import Mora_II_Concert_Hero from '../assets/images/Mora_II_Concert_Hero.png';
import Mora_II_Header from '../assets/images/Mora_II_Header.jpg';
import Acoustic_Mora_II_Concert from '../assets/images/Acoustic_Mora_II_Concert.png';
import Acoustic_Mora_II_Concert_Back from '../assets/images/Acoustic_Mora_II_Concert_Back.png';
      ...
      <Wrapper>
        <IntroBackground>
          <IntroContainer>
            ...
            <IntroImage src={Mora_II_Concert_Hero} alt='' />
          </IntroContainer>
        </IntroBackground>
        <NavContainer>
          <NavWrapper>
        ...
        <MainContentWrapper>
          <LeftContentWrapper>
            <MediaTitle>Hagstrom Mora II Concert</MediaTitle>
            <Paragraph>
              <LogoSpan>
        ...
        <LightboxWrapper>
          <Lightbox
            ...
            close={() => setOpen(false)}
            slides={[
              { src: Acoustic_Mora_II_Concert },
              { src: Acoustic_Mora_II_Concert_Back },
            ]}
          />
        </LightboxWrapper>
        <SpecsWrapper>
          <LeftSpecsWrapper>
            <MediaTitle>Mora II Concert Specs</MediaTitle>
          ...
          <RightSpecsWrapper>
            <MediaTitle>Mora II Concert Standards</MediaTitle>
            <StandardsWrapper>
...
export default MoreInfoMoraIIConcert;
