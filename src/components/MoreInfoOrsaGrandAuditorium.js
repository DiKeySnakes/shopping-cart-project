...
import Orsa_Grand_Auditorium_Hero from '../assets/images/Orsa_Grand_Auditorium_Hero.png';
import Orsa_Header from '../assets/images/Orsa_Header.jpg';
import Acoustic_Orsa_GA from '../assets/images/Acoustic_Orsa_GA.png';
import Acoustic_Orsa_GA_Back from '../assets/images/Acoustic_Orsa_GA_Back.png';
...
const MoreInfoOrsaGrandAuditorium = () => {
      ...
      <Wrapper>
        <IntroBackground>
          <IntroContainer>
            ...
            <IntroImage src={Orsa_Grand_Auditorium_Hero} alt='' />
          </IntroContainer>
        </IntroBackground>
        <NavContainer>
          <NavWrapper>
        ...
        <MainContentWrapper>
          <LeftContentWrapper>
            <MediaTitle>Hagstrom Orsa Grand Auditorium</MediaTitle>
            <Paragraph>
              <LogoSpan>
        ...
        <LightboxWrapper>
          <Lightbox
            ...
            open={open}
            close={() => setOpen(false)}
            slides={[{ src: Acoustic_Orsa_GA }, { src: Acoustic_Orsa_GA_Back }]}
          />
        </LightboxWrapper>
        <SpecsWrapper>
          <LeftSpecsWrapper>
            <MediaTitle>Orsa Grand Auditorium Specs</MediaTitle>
            <MediaTitleSecondary>Body</MediaTitleSecondary>
            <ul>
              <li>Material: Ovangol</li>
              <li>Shape: Grand Auditorium</li>
          ...
          <RightSpecsWrapper>
            <MediaTitle>Orsa Grand Auditorium Standards</MediaTitle>
            <StandardsWrapper>
...
export default MoreInfoOrsaGrandAuditorium;
