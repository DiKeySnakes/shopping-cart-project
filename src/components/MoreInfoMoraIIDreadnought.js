...
import Mora_II_Dreadnought_Hero from '../assets/images/Mora_II_Dreadnought_Hero.png';
import Mora_II_Header from '../assets/images/Mora_II_Header.jpg';
import Acoustic_Mora_II_Dreadnought from '../assets/images/Acoustic_Mora_II_Dreadnought.png';
import Acoustic_Mora_II_Dreadnought_Back from '../assets/images/Acoustic_Mora_II_Dreadnought_Back.png';
...
const MoreInfoMoraIIDreadnought = () => {
      ...
      <Wrapper>
        <IntroBackground>
          <IntroContainer>
            ...
            <IntroImage src={Mora_II_Dreadnought_Hero} alt='' />
          </IntroContainer>
        </IntroBackground>
        <NavContainer>
          <NavWrapper>
        ...
        <MainContentWrapper>
          <LeftContentWrapper>
            <MediaTitle>Hagstrom Mora II Dreadnought</MediaTitle>
            <Paragraph>
              <LogoSpan>
        ...
        <LightboxWrapper>
          <Lightbox
            ...
            close={() => setOpen(false)}
            slides={[
              { src: Acoustic_Mora_II_Dreadnought },
              { src: Acoustic_Mora_II_Dreadnought_Back },
            ]}
          />
        </LightboxWrapper>
        <SpecsWrapper>
          <LeftSpecsWrapper>
            <MediaTitle>Mora II Dreadnought Specs</MediaTitle>
          ...
          <RightSpecsWrapper>
            <MediaTitle>Mora II Dreadnought Standards</MediaTitle>
            <StandardsWrapper>
...
export default MoreInfoMoraIIDreadnought;
