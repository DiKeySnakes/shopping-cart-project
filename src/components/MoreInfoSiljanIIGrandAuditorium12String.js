...
import Siljan_II_GA_12_Hero from '../assets/images/Siljan_II_GA_12_Hero.png';
import Siljan_II_Header from '../assets/images/Siljan_II_Header.jpg';
import Acoustic_Siljan_II_GA_12_String from '../assets/images/Acoustic_Siljan_II_GA_12_String.png';
import Acoustic_Siljan_II_GA_12_String_Back from '../assets/images/Acoustic_Siljan_II_GA_12_String_Back.png';
...
const MoreInfoSiljanIIGrandAuditorium12String = () => {
      ...
      <Wrapper>
        <IntroBackground>
          <IntroContainer>
            ...
            <IntroImage src={Siljan_II_GA_12_Hero} alt='' />
          </IntroContainer>
        </IntroBackground>
        <NavContainer>
          <NavWrapper>
            <NavLinks>
              ...
              <span>/</span>
              <NavLink>Grand Auditorium 12 String</NavLink>
            </NavLinks>
            <ShareLinks>
              <NavLink>
        ...
        <MainContentWrapper>
          <LeftContentWrapper>
            <MediaTitle>
              Hagstrom Siljan II Grand Auditorium 12 String
            </MediaTitle>
            <Paragraph>
              <LogoSpan>
        ...
        <LightboxWrapper>
          <Lightbox
            ...
            close={() => setOpen(false)}
            slides={[
              { src: Acoustic_Siljan_II_GA_12_String },
              { src: Acoustic_Siljan_II_GA_12_String_Back },
            ]}
          />
        </LightboxWrapper>
        <SpecsWrapper>
          <LeftSpecsWrapper>
            <MediaTitle>Siljan II Grand Auditorium 12 String Specs</MediaTitle>
            <MediaTitleSecondary>Body</MediaTitleSecondary>
            <ul>
              <li>Material: Mahogany</li>
              <li>Shape: Grand Auditorium 12-String with Cutaway</li>
          ...
          <RightSpecsWrapper>
            <MediaTitle>
              Siljan II Grand Auditorium 12 String Standards
            </MediaTitle>
            <StandardsWrapper>
...
export default MoreInfoSiljanIIGrandAuditorium12String;
