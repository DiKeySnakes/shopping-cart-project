...
import Mora_II_Dreadnought_CE_Hero from '../assets/images/Mora_II_Dreadnought_CE_Hero.png';
import Mora_II_Header from '../assets/images/Mora_II_Header.jpg';
import Acoustic_Mora_II_Dreadnought_CE from '../assets/images/Acoustic_Mora_II_Dreadnought_CE.png';
import Acoustic_Mora_II_Dreadnought_CE_Back from '../assets/images/Acoustic_Mora_II_Dreadnought_CE_Back.png';
...
const MoreInfoMoraIIDreadnoughtCE = () => {
      ...
      <Wrapper>
        <IntroBackground>
          <IntroContainer>
            ...
            <IntroImage src={Mora_II_Dreadnought_CE_Hero} alt='' />
          </IntroContainer>
        </IntroBackground>
        <NavContainer>
          <NavWrapper>
        ...
        <MainContentWrapper>
          <LeftContentWrapper>
            <MediaTitle>Hagstrom Mora II Dreadnought CE</MediaTitle>
            <Paragraph>
              <LogoSpan>
        ...
        <LightboxWrapper>
          <Lightbox
            ...
            close={() => setOpen(false)}
            slides={[
              { src: Acoustic_Mora_II_Dreadnought_CE },
              { src: Acoustic_Mora_II_Dreadnought_CE_Back },
            ]}
          />
        </LightboxWrapper>
        <SpecsWrapper>
          <LeftSpecsWrapper>
            <MediaTitle>Mora II Dreadnought CE Specs</MediaTitle>
          ...
          <RightSpecsWrapper>
            <MediaTitle>Mora II Dreadnought CE Standards</MediaTitle>
            <StandardsWrapper>
...
export default MoreInfoMoraIIDreadnoughtCE;
